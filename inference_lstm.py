...
cap = cv2.VideoCapture("C:\\Users\\herow\\Robotic_hand\\Violence-Detection\\video (1080p).mp4")

mpPose = mp.solutions.pose
pose = mpPose.Pose()
mpDraw = mp.solutions.drawing_utils

model = keras.models.load_model("C:\\Users\herow\\Robotic_hand\\Violence-Detection\\lstm-model.h5")
...
while True:
    ret, frame = cap.read()
    frame = cv2.resize(frame, (display_width, display_height))  # Resize the frame
